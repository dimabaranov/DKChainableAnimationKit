...
class ViewController: UIViewController {
    ...
    let secondView: UIView = UIView(
        frame: CGRect(x: 300, y: 250, width: 50, height: 50)
    )
    ...
    override func viewDidLoad()
    {
        ...
        button.frame = CGRect(
            ...
            width: self.view.bounds.size.width, height: 50)
    ...
    @objc func animateView(_ sender: UIButton) {
        ...
        secondView
            .animation
                ...
                .thenAfter(0.5)
            .moveY(200)
        .makeBackground(green)
            .thenAfter(0.5).makeBackground(white).thenAfter(0.2).makeBackground(black).thenAfter(0.2).makeBackground(white).animate(0.2)
